...
int32_t CustomizedVideoDecoderProxy::InitDecode(const VideoCodec* codec_settings, int32_t number_of_cores) {
  ...
  if (external_decoder_) {
    if (codec_type_ == kVideoCodecH264 && external_decoder_->InitDecodeContext(MediaCodec::VideoCodec::H264)) {
      return WEBRTC_VIDEO_CODEC_OK;
    } else if (codec_type_ == kVideoCodecVP8 && external_decoder_->InitDecodeContext(MediaCodec::VideoCodec::VP8)) {
      return WEBRTC_VIDEO_CODEC_OK;
    }
