...
namespace woogeen {
RTCP2PSignalingSenderObjcImpl::RTCP2PSignalingSenderObjcImpl(id<RTCP2PSignalingSenderProtocol> sender) {
  _sender = sender;
}

void RTCP2PSignalingSenderObjcImpl::SendSignalingMessage(const std::string& message, const std::string& remote_id, std::function<void()> success, std::function<void(int)> failure) {
