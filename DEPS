...
deps = {
  ...
  'src/third_party/chromium/tools/swarming_client':
  ...
  'src/third_party/webrtc':
    Var('internal_ccr1_git') + '/webrtc-webrtcstack.git' + '@' + '409b2fe0be3291ac20bf5b2d8c925d65be6d94c7',
...
hooks_os={
  'android':[
    ...
    # such dependencies we share with Chromium.
    {
      ...
      'action': ['python',
                 'src/third_party/chromium/build/android/play_services/update.py',
                 'download'
      ],
    },
    {
      ...
      'pattern': '.',
      'action': ['python',
                 'src/third_party/chromium/build/android/update_deps/update_third_party_deps.py',
                 'download',
                 '-b', 'chromium-intellij',
